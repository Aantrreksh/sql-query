...
All table metadata has been created before that date are encrypted using service-managed encryption. You may re-create tables to convert the encryption method tp BYOK using {{site.data.keyword.keymanagementservicefull}}.
