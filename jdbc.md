...
Download the latest version: [`2.7.0`](https://us.sql-query.cloud.ibm.com/download/jdbc/ibmcloudsql-jdbc-2.7.0.jar)

[previous-ibmcloudsql-jdbc-jar]: <> "lines=1 search=\[.*\](.*) replace=ref:ibmcloudsql-jdbc-jar:link"
Here you find the previous version for reference: [`2.6.2`](https://us.sql-query.cloud.ibm.com/download/jdbc/ibmcloudsql-jdbc-2.6.2.jar)
