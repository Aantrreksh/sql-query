...
!wget https://us.sql-query.cloud.ibm.com/download/catalog/dataengine_spark-1.2.2-py3-none-any.whl -O /tmp/dataengine/dataengine_spark-1.2.2-py3-none-any.whl
# user-libs/spark2 is in the classpath of Spark
!wget https://us.sql-query.cloud.ibm.com/download/catalog/dataengine-spark-integration-1.2.2.jar -O user-libs/spark2/dataengine-spark-integration-1.2.2.jar
...
!pip install --force-reinstall /tmp/dataengine/dataengine_spark-1.2.2-py3-none-any.whl
...
- [spark-dataengine-scala](https://us.sql-query.cloud.ibm.com/download/catalog/dataengine-spark-integration-1.2.2.jar)
- [spark-dataengine-python](https://us.sql-query.cloud.ibm.com/download/catalog/dataengine_spark-1.2.2-py3-none-any.whl)
