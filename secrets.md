...
![Secure Credential Passing in {{site.data.keyword.sqlquery_short}}.](images/accesssecrets_new.svg "Secure Credential Passing in {{site.data.keyword.sqlquery_short}}"){: caption="Secure Credential Passing in {{site.data.keyword.sqlquery_short}}" caption-side="bottom"}
