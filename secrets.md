...
![Secure Credential Passing in SQL Query.](images/accesssecrets_new.svg "Secure Credential Passing in SQL Query"){: caption="Figure 1. Secure Credential Passing in SQL Query" caption-side="bottom"}
